...
namespace Aquamarine.Source.Networking.Messages;

/// <summary>
/// Message sent from authority back to clients to confirm or correct their delta changes.
/// Prevents cheating and ensures state consistency.
/// </summary>
