...
namespace Lumora.Nexus.Transport.Relay;

// An IConnection that carries session traffic through the relay server instead of a direct socket.
// Used as the fallback when NAT punchthrough can't open a direct path. Wraps a SessionServerClient:
// outgoing frames go out as relay packets, incoming relay packets surface as received data.
