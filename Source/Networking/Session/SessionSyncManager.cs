...
using Aquamarine.Source.Networking.LNL;
...
using StreamType = Aquamarine.Source.Networking.Sync.StreamType;
...
public class SessionSyncManager : IDisposable
{
    ...
    {
        World.ConnectorManager.DataModelLock(Thread.CurrentThread);
        ...
        World.ConnectorManager.DataModelUnlock();
            ...
            if (World.IsAuthority)
            {
                ...
                foreach (var record in delta.Records)
                {
                    ...
                    else
                    {
                        ...
                        {
                            correctedData = GodotSerializer.Serialize(validation.CorrectedValue);
                        }
