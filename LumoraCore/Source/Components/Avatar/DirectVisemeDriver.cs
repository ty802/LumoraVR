...
/// <summary>
/// Lip-sync: maps a <see cref="VisemeAnalyzer"/>'s per-viseme weights onto the avatar's viseme
...
public sealed class DirectVisemeDriver : Component
{
    public readonly SyncRef<VisemeAnalyzer> Source = new();
    ...
    private void ResolveTargets()
    {
        ...
        if (Source.Target == null || Source.Target.IsDestroyed)
            Source.Target = Slot.GetComponentInChildren<VisemeAnalyzer>() ?? Slot.GetComponent<VisemeAnalyzer>();
