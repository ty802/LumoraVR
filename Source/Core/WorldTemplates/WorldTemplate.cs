...
public abstract class WorldTemplate
{
    ...
    {
        // Create UserRoot for managing users in the world
        var userRootSlot = world.RootSlot.AddSlot("Users");
        userRootSlot.Tag.Value = "UserRoot";
        var userRoot = userRootSlot.AttachComponent<UserRootComponent>();
