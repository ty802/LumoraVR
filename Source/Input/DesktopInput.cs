...
public partial class DesktopInput : Node3D, IInputProvider
{
    ...
    public Vector3 GetLimbPosition(IInputProvider.InputLimb limb) => Vector3.Zero;
    ...
    public void MoveTransform(Transform3D transform) => _root.GlobalTransform = transform;
}
