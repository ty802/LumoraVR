...
public class SessionServerClient : IDisposable, INetEventListener, INatPunchListener
{
    ...
    // Plain relay client, no session registration. Used by the joining peer so it can request a relay
    // and exchange relay packets.
    ...
    // Called when the server notifies us of an incoming client.
